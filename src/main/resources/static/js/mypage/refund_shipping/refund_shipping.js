...
function updateTable(data) {
    ...
    $.each(data, function(index, orderDetailVo) {
        let row = $("<tr>").addClass("table_data");
        row.append($("<td>").text(orderDetailVo.orderDate + '/' + orderDetailVo.orderNumber));
        row.append($("<td>").text(orderDetailVo.productName));
        row.append($("<td>").text(orderDetailVo.productPrice + '/' + orderDetailVo.orderDetailCount));
        row.append($("<td>").text(orderDetailVo.orderStatusName));
        row.append($("<td>").text(orderDetailVo.reviewCount));

        tbody.append(row);

    });

    $("#shipping_total_search").text(data.length);
}